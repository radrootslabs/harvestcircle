...
class SecretClipboardControllerTest {
    @Test
    fun clearsCopiedSecretAfterDelayWhenClipboardIsUnchanged() =
        runTest {
    ...
    @Test
    fun preservesClipboardContentReplacedByUserBeforeDelay() =
        runTest {
            val clipboard = FakeTextClipboard()
            val controller = SecretClipboardController(this, clipboard, clearDelayMillis = 60_000)
    ...
    @Test
    fun replacingCopiedSecretCancelsEarlierClearTimer() =
        runTest {
            val clipboard = FakeTextClipboard()
            val controller = SecretClipboardController(this, clipboard, clearDelayMillis = 60_000)
    ...
    @Test
    fun disposalClearsOnlyClipboardTextOwnedByController() =
        runTest {
            val clipboard = FakeTextClipboard()
    ...
    @Test
    fun clipboardFailuresReturnTypedUnavailableAndNeverCrashCleanup() =
        runTest {
